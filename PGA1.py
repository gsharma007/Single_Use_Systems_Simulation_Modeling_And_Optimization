...
# -*- coding: utf-8 -*-
"""
Created on Tue June 21 17:10:24 2019
...
# drawn from exponential dist with rate of 0.5 hours
...
# drawn from triangular dist between 3 and 5 hours
# with  mode and mean at 4 hour
service_times_harvesting = np.random.triangular(left=3, mode=4, right=5, size=(NUM_MACHINES, NUM_CUSTOMERS))
...
#  drawn from triangular dist between 216 and 264 hours
#  with  mode and mean at 5 hour
manufacturing_times = np.random.triangular(left=14, mode=15, right=16, size=(NUM_MANUF_MACHINES, NUM_CUSTOMERS))
...
print("mean total time in days: ", np.mean(Total_time_in_System)/24, "\n")