...
DOE_Plot13 = plotting.scatter_matrix(df_consol_final[['Machine_Count', 'Operators_Count', 'Product_mix','Achieved_Yield_from_Mfg']], diagonal= 'kde')
plt.show()
...
#DOE_Plot6.figure.savefig('DOE_Plot6.png')
#DOE_Plot7.figure.savefig('DOE_Plot7.png')
